  ...
  return (
    ...
    >
      <div className="w-full max-w-sm">
        ...
        <Link
          to={ROUTES.HOME}
          className="mt-3 flex w-full items-center justify-center rounded-xl border py-3 text-xs font-semibold tracking-widest transition-all hover:border-[#C2A98A] hover:text-[#C2A98A]"
          style={{ borderColor: "#E5DCD3", color: "#7A6E67", backgroundColor: "#FFFFFF" }}
        >
          CONTINUE AS GUEST
        </Link>
